...
namespace EventManager.WebApi.Controllers
{
  [Route("api/address")]
  [ApiController]
  [SwaggerResponse(StatusCodes.Status400BadRequest, "Błąd po stronie adresu, błędne dane wejściowe do usługi.")]
  ...
  public class AddressController : ControllerBase
  {
    ...
    public async Task<IActionResult> GetById([Required] string id)
    {
      ...
      return result == null
        ? NotFound()
        : Ok(dtoBuilder.ConvertToAddressDto(result));
    }
    ...
    public async Task<IActionResult> Search([FromQuery] AddressQuery query)
    {
      ...
      return Ok(results.Select(u => dtoBuilder.ConvertToAddressDto(u)).ToList());
    }
    ...
    public async Task<IActionResult> GetAll()
    {
      ...
      return Ok(results.Select(s => dtoBuilder.ConvertToAddressDto(s)).ToList());
    }
    ...
    public async Task<IActionResult> Put([FromQuery][Required] string id, [FromBody] AddressStoreDto addressDto)
    {
