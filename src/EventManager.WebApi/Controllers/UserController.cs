...
namespace EventManager.WebApi.Controllers
{
  ...
  public class UserController : ControllerBase
  {
    ...
    public async Task<IActionResult> Search([FromQuery] UserQuery query)
    {
      ...
      return Ok(users.Select(u => dtoBuilder.ConvertToUserDto(u)).ToList());
    }
    ...
    public async Task<IActionResult> GetAll()
    {
      ...
      return Ok(users.Select(s => dtoBuilder.ConvertToUserDto(s)).ToList());
    }
    ...
    public async Task<IActionResult> Put([FromQuery][Required] string id, [FromBody] UserStoreDto userDto)
    {
